...
void exec(cgicc::FCgiCC<> &cgi) {
    ...
    const auto user_id_1 = db_insert(db_user, User{
        genOID(),
    ...
    const auto user_id_2 = db_insert(db_user, User{
        genOID(),
    ...
    const auto user_id_3 = db_insert(db_user, User{
        genOID(),
    ...
    const auto user_id_4 = db_insert(db_user, User{
        genOID(),
    ...
    const auto book_id_1 = db_insert(db_book, Book{
    ...
    const auto book_id_2 = db_insert(db_book, Book{
    ...
    const auto book_id_3_1 = db_insert(db_book, Book{
    ...
    const auto book_id_3_2 = db_insert(db_book, Book{
    ...
    const auto book_id_4 = db_insert(db_book, Book{
        genOID(), user_id_4, cat_id_1_3,
    ...
    const auto book_id_5 = db_insert(db_book, Book{
    ...
    const auto book_id_x = db_insert(db_book, Book{
    ...
    const auto book_id_6 = db_insert(db_book, Book{
